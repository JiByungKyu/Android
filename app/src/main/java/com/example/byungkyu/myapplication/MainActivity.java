    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            *//*고장정보 insert 구문*//*
            ...
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('E000051-03', '쓰로틀 포지션 센서 1번 배터리와 단락', " +
                    "'Throttle Position Sensor 1, short circuit to battery.', 207, 3);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('E000051-04', '쓰로틀 포지션 센서 1번 그라운드와 단락', 'Throttle Position Sensor 1, Short " +
                    "Circuit to Ground', 207, 4);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('E000051-07', '조정된 쓰로틀 포지션센서 전 " +
            ...
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('E000051-08', '조정된 쓰로틀 포지션센서 전" +
                    "압이 Open end에서 허용된 범위를 넘어섬', 'Adapted throttle position sensor " +
                    "voltage, at open end position, is" + "outside permitted range', 207, 8);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('E000051-09', '쓰로틀 포지션센서(들) 동작이 잘못되거나 상호관계 오류', " +
                    "'Throttle Position Sensor(s) Bad Performance, Correlation Error', 207, 9);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('E000091-02', '보조 악셀페달이 페달고장이나 " +
                    "다른 결함으로 사용 중', 'Auxiliary accelerator pedal is used due to pedal faulty or other.', 210, 2);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('E000091-09', '악셀 페달 고장 혹은 오류 (via CAN)', 'Acc pedal faulty or error via can.', 210, 9);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('E000091-10', 악셀 페달 적절하지 않음, 고장', 'Accelerator pedal not plausible, faulty', 210, 10);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('E000091-19', '악셀 페달값이 적절한 범위에서 벗어남 (via CAN)', 'Acc pedal value out of valid range (via CAN)', 210, 19);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('VCO001-11', '계기판 통신이상', 'GAUGE PANEL ERROR', 11, 11);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('VCO002-11', 'E-ECU 통신이상', 'E-ECU ERROR', 23, 11);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('VPV001-05', '펌프 비례 밸브(A) 전류가 정상 " +
                    "범위보다 낮음(개방)', 'PUMP P/V (A), Current below normal', 25, 5);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('VPV001-06', '펌프 비례 밸브(A) 전류가 정상 " +
                    "범위보다 높음(단락)', 'PUMP P/V (A), Current above normal', 25, 6);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('VPV002-05', '펌프 비례 밸브(B) 전류가 정상 " +
                    "범위보다 낮음(개방)', 'PUMP P/V (B), Current below normal', 34, 5);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('VPV002-06', '펌프 비례 밸브(B) 전류가 정상 " +
                    "범위보다 높음(단락)', 'PUMP P/V (B), Current above normal', 34, 6);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('VPV003-05', '유량제어 비례 감압 밸브 (G) " +
                    "전류가 정상 범위보다 낮음(개방)', 'FLOW CONTROL P/V (G), Current below normal', 56, 5);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('VPV003-06', '유량제어 비례 감압 밸브 (G) " +
                    "전류가 정상 범위보다 높음(단락)', 'FLOW CONTROL P/V (G), Current above normal', 56, 6);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('VPV004-05', '팬 제어 비례 감압 밸브 (J) 전" +
                    "류가 정상 범위보다 낮음(개방)', 'FAN CONTROL P/V (J), Current below normal', 42, 5);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('VPV004-06', '팬 제어 비례 감압 밸브 (J) 전" +
                    "류가 정상 범위보다 높음(단락)', 'FAN CONTROL P/V (J), Current above normal', 42, 6);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('VPV005-05', '압력 제어 비례 감압 밸브 (H) " +
                    "전류가 정상 범위보다 낮음(개방)', 'FAN CONTROL P/V (J), Current PRESS. CONTROL 1 P/V (H), Current below normal', 89, 5);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('VPV005-06', '압력 제어 비례 감압 밸브 (H) " +
                    "전류가 정상 범위보다 높음(단락)', 'PRESS. CONTROL 1 P/V (H), Current above normal', 89, 6);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('VPV006-05', '압력 제어 비례 감압 밸브 (I) " +
                    "전류가 정상 범위보다 낮음(개방)', 'PRESS. CONTROL 2 P/V (I), " +
                    "Current below normal', 77, 5);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('VPV006-06', '압력 제어 비례 감압 밸브 (I) " +
                    "전류가 정상 범위보다 높음(단락)', 'FAN CONTROL P/V (J), Current above normal', 77, 6);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('VPV007-05', '유량제어 비례 감압 밸브 (C) " +
                    "2-WAY 좌측고압 전류가 정상범위보다 낮음(개방)', 'FLOW CONTROL P/V (C) 2-WAY RH-OPEN, Current below normal', 102, 5);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('VPV007-06', '유량제어 비례 감압 밸브 (C) " +
                    "2-WAY 좌측고압 전류가 정상 범위보다 높음(단락)', 'FLOW CONTROL P/V (C) 2-WAY RH-OPEN, Current above normal', 102, 6);");
            db.execSQL("insert into fault_code_list_tb(ID, CONTENT_KR, CONTENT_ER, INDEX, FMI) values('VPV008-05', '유량제어 비례 감압 밸브 (D) " +
